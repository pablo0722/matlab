function [fft_x, fft_y] = fft_abs(signal,Length,Fs)
% fft_abs devuelde el modulo de la fft de una se�al y su respectivo eje de frecuencias
%
...
% Version 1.0 01-10-2014
    ...
    fft_y = abs(signal_f(1:int64(NFFT/2+1)));
end