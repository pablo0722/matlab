...
%
% Filtro pasa-banda con alto Q (ancho de banda reducido).
% La frecuencia central varia hacia arriba y abajo en el espectro.
%
% Difference equation taken from DAFX chapter 2
%
% Cambiando de pasa-banda a rechaza-banda (notch), convierte el efecto
% de un wah-wah a un phaser
%
% yl(n) = F1*yb(n) + yl(n-1)
% yb(n) = F1*yh(n) + yb(n-1)
% yh(n) = x(n) - yl(n-1) - Q1*yb(n-1)
%
% varia Fc de 500 Hz a 5 kHz
