function [y fs] = flanger_centrado(filename, depth, rango, frec, delay)
% [y] = flanger(fs, v, x, r)
% Efecto de flanging centrado (haciendo que el flanging se pueda adelantar a la muestra actual)
%
